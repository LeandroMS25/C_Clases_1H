...
static int isFloat(char* cadena, int limite); // Se utiliza en getFloat.
...
static int isCuit(char* cadena,int limite);
/**
 ...
 * \ param - char* pResultado, puntero a dirección de memoria.
 * \ param - int longitud, indica la cantidad de letras maximas de la cadena.
 * \ return - (-1) en caso de error / (0) en caso de funcionar.
 */
