...
/** \brief Recibe el puntero a una función
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
 ...
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
 */
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void*,char*), char* zona)
{
...
// Llaman a un funcion que devuelve un valor y termina acumulando
